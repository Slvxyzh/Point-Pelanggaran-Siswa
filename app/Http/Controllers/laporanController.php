...
class laporanController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('laporan.tb_create', compact( 'laporan','siswa','guru','pelanggaran'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('laporan.tb_edit', compact('laporan'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/dasboard/laporan')
    ...
    public function destroy($id)
    {
        	...
        	$laporan->delete();
        	return redirect()->route('/dasboard/laporan')
